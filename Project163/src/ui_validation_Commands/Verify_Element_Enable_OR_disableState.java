...
public class Verify_Element_Enable_OR_disableState 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		/*
		 * Testcase:-->Verify locality editbox is disable before state and city selection.
		...
		if(!Locality_Editbox.isEnabled()) //!--Not
			System.out.println("Testpass-Editbox is disabled before selection of state and city");
		else
			System.out.println("Testfail editbox is enabled before selection of state and city");
